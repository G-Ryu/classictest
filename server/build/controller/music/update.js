...
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, _a, singer, track, album, musicId, music, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                userId = req.userId;
                _a = req.body, singer = _a.singer, track = _a.track, album = _a.album, musicId = _a.musicId;
                if (!userId) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, typeorm_1.getRepository(Music_1.Music)
